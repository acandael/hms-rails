...
describe 'viewing a publication' do
  it 'shows the publication details' do
    ...
    publication = Publication.create!(date: "12 june 2015".to_date, 
                                      title: "publication 1", 
                                      category_id: category.id, 
                                      description: "book review", 
                                      summary: "this is the summary", 
                                      link: "http://www.ugent.be/ps",
                                      external_authors: "Rebeca De Dobbelaer")
    ...
    expect(page).to have_text publication.external_authors
  end
end
